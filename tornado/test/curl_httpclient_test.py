...
from tornado.httpclient import HTTPError, HTTPRequest, HTTPClientError
...
class CurlHTTPClientTestCase(AsyncHTTPTestCase):
    ...
    def test_timeout_must_close_connection(self):
        ...
        try:
            response = yield self.http_client.fetch(HTTPRequest("http://127.0.0.1:%d/" % port, request_timeout=1))
